 ...
 */
package io.cloudslang.content.blueocean.actions.user;
...
import static io.cloudslang.content.blueocean.entities.constants.Inputs.StandardInputs.TOKEN;
import static io.cloudslang.content.blueocean.entities.constants.Inputs.UserInputs.USER;
...
public class GetUser {
    /**
     * Retrieve provided user information.
     * https://github.com/jenkinsci/blueocean-plugin/tree/master/blueocean-rest#get-a-user
     *
     ...
     *                             Valid values: "true", "false"
     *                             Default value: "true"
     * @param token                Authentication token needed when make the request.
     *                             See: https://github.com/jenkinsci/blueocean-plugin/blob/master/blueocean-jwt/README.md
     * @param user                 Name of the user to retrieve information for.
    ...
    public Map<String, String> getUser(@Param(value = PROTOCOL) String protocol,
